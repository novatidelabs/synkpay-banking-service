...
describe("CurrenciesManagementController", () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<CurrenciesManagementController>(
      CurrenciesManagementController,
    );
  ...
  describe("getCurrencies", () => {
    ...
    it("should return currencies successfully", async () => {
      ...
      mockCurrenciesManagementService.getCurrencies.mockResolvedValue(
        mockResult,
      );
  ...
  describe("createCurrency", () => {
    ...
    it("should create currency successfully", async () => {
      ...
      mockCurrenciesManagementService.createCurrency.mockResolvedValue(
        mockResult,
      );

      await controller.createCurrency(
        callerId,
        createCurrencyDto,
        mockRequest,
        mockResponse,
  ...
  describe("getCurrenciesView", () => {
    ...
    it("should get currencies view successfully", async () => {
      ...
      mockCurrenciesManagementService.getCurrenciesView.mockResolvedValue(
        mockResult,
      );

      await controller.getCurrenciesView(
        callerId,
        currencyViewDto,
        mockRequest,
        mockResponse,
      ...
      expect(service.getCurrenciesView).toHaveBeenCalledWith(
        callerId,
        currencyViewDto,
        "Bearer test-token",
      );
  ...
  describe("updateCurrency", () => {
    ...
    it("should update currency successfully", async () => {
      ...
      mockCurrenciesManagementService.updateCurrency.mockResolvedValue(
        mockResult,
      );
  ...
  describe("setMainCurrency", () => {
    ...
    it("should set main currency successfully", async () => {
      ...
      mockCurrenciesManagementService.setMainCurrency.mockResolvedValue(
        mockResult,
      );

      await controller.setMainCurrency(
        currencyId,
        callerId,
        mockRequest,
        mockResponse,
      ...
      expect(service.setMainCurrency).toHaveBeenCalledWith(
        callerId,
        currencyId,
        "Bearer test-token",
      );
